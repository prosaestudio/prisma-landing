...
export function SiteFooter() {
  return (
    <footer className="relative z-10 overflow-hidden bg-form-sand pt-10">
      <img
        src={bgPrisma.url}
        alt=""
        aria-hidden
        loading="lazy"
        className="pointer-events-none absolute left-0 top-[10%] -z-10 h-[160%] w-full object-cover object-bottom"
      />
